...
from etiquetado.modulos.imagenes.infraestructura.schema.v1.eventos import EventoImagenProcesada, ImagenProcesadaPayload
...
class Despachador:
    ...
    def publicar_evento(self, evento, topico):
        ...
        payload = ImagenProcesadaPayload(
            ...
            id_etiquetado=str(evento.id_etiquetado),
