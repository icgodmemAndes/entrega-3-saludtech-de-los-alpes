...
def create_app(configuracion={}):
    ...
    # Inicializa la DB
    from etiquetado.config.db import init_db
    init_db(app)
    ...
    # Importa Blueprints
    from . import etiquetado

    # Registro de Blueprints  
    app.register_blueprint(etiquetado.bp)

    @app.route("/etiquetado/spec")
    def spec():
        swag = swagger(app)
